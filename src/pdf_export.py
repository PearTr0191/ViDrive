...
from src.config import PARKING_TOLL_ESTIMATES, APP_VERSION
...
def _generate_text_report_single(car_id: str, year: int, res: dict, city: str, km: int, years: int, area: int, ratio: float, show_opp: bool, loan: dict | None = None) -> str:
    ...
    lines.append(f"Language: {'English' if _lang == 'en' else 'Tiếng Việt'} | ViDrive v{APP_VERSION}")
    lines.append("")
    ...
    lines.append("")
    lines.append("-" * 60)
    lines.append(f"Generated by ViDrive TCO Calculator v{APP_VERSION}")
...
def _generate_text_report_compare(cars_data: list, results: list, year: int, city: str, km: int, years: int, area: int, ratio: float, show_opp: bool, loans: list | None = None) -> str:
    ...
    lines.append("")
    lines.append("-" * 80)
    lines.append("Generated by ViDrive TCO Calculator v{APP_VERSION}")
    lines.append("For informational purposes only. Not financial advice.")
    lines.append("=" * 80)
...
def generate_pdf_single(car_id: str, year: int, res: dict, city: str, km: int, years: int, area: int, ratio: float, show_opp: bool, loan: dict | None = None) -> str:
...
def generate_pdf_compare(cars_data: list, results: list, year: int, city: str, km: int, years: int, area: int, ratio: float, show_opp: bool, loans: list | None = None) -> str:
